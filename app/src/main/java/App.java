...
import main.java.models.Articulo;
import main.java.models.Cliente;
import main.java.models.DetallePedido;
import main.java.models.Imagen;
import main.java.models.Pedido;
import main.java.models.UnidadMedida;
...
public class App {    
    public static void main(String[] args) {
        ...
        .fechaNacimiento(LocalDate.parse("2004-07-15"))
        .build();
        ...
        .fechaNacimiento(LocalDate.parse("1998-04-05"))
        .build();
        ...
        .fechaNacimiento(LocalDate.parse("2000-01-27"))
        .build();
